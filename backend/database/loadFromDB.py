...
class DB_Data(BaseConfig):
    ...
    def readBiliBiliComment(self, Location=None, ID_Index=1, length=-1):
        ...
        """
        if Location == -1:
            Location = self.ExampleDataRoute
        if Location is None:
            self.data = [
    ...
    def readWangyiNews(self):
        self.data = [
            {self.ID_Index: 1,
             self.NewsInfo_location: '北京', 'time': '2023-09-04 10:22:14',
             self.NewsInfo_source: "手机中国",
            ...
            {self.ID_Index: 1,
             self.NewsInfo_location: '北京', 'time': '2023-09-04 20:25:19',
             self.NewsInfo_source: "手机中国",
